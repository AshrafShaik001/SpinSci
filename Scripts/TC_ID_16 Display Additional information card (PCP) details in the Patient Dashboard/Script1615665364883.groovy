...
def name = "Smith, John";
def contactNumber = "608-271-9000";
...
// Verify Emergency Contact Information information in Emergency Contact Information card
CustomKeywords.'cards.EmergencyContactInformationCard.verifyEmergencyContactDetails'(name, contactNumber);
